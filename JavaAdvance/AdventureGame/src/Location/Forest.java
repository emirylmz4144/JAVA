...
public class Forest extends BattleLoc {
    ...
    /*
     *Lokasyona player geleceği için yapıcı metotta player sınıfından player nesnesini atarız
     * Loksasyona ait canavar türünü yapıcı metota atarız
     */
    public Forest(Player player) {
        super("Orman", player, new Vampire());
    }
    ...
    public void locationBehavior()//lokasyona davranışının 0lduğu metottur
    {
        ...
        System.out.println("Dikkat et ormanda " + obstacle.getName() + " karşılaşabilirsin..  ");
        System.out.println("""
                Ne yapmak isterin:\s
                1-Savaş
                2-Kaç""");
